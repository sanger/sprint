 ...
 */
export type SetCanvasToParentScale = HasActionType<
  "SET_CANVAS_TO_PARENT_SCALE"
> & {
  value: number;
};
 ...
 */
export type AddCanvasBarcodeField = HasActionType<
  "ADD_CANVAS_BARCODE_FIELD"
> & {
 ...
 */
export type UpdateBarcodeFieldDrawnDimensions = HasActionType<
  "UPDATE_BARCODE_FIELD_DRAWN_DIMENSIONS"
> & {
  canvasField: CanvasField;
  value: TwoDimensional;
};
 ...
 */
export type SetCanvasMousePosition = HasActionType<
 ...
 */
export type SetSelectedCanvasField = HasActionType<
  "SET_SELECTED_CANVAS_FIELD"
> & {
  value: CanvasField;
};
 ...
 */
export type DeleteSelectedCanvasField = HasActionType<
  "DELETE_SELECTED_CANVAS_FIELD"
>;
